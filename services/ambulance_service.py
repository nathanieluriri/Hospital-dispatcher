...
from repositories.ambulance_repo import find_ambulance_by_id,create_ambulance,delete_admin_by_id,update_ambulance_details,find_all_ambulances
...
def delete_ambulance_service(ambulance_id:int)->int:
    return delete_admin_by_id(ambulance_id=ambulance_id)